...
-- Schema kovid
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS kovid;
...
CREATE TABLE IF NOT EXISTS kovid.Report (
  ...
  CONSTRAINT Report_Id_UNIQUE UNIQUE  (Report_Id))
;
...
CREATE TABLE IF NOT EXISTS kovid.ReportSched (
  ...
  CONSTRAINT Sched_Id_UNIQUE UNIQUE  (Sched_Id )
 ,
...
CREATE TABLE IF NOT EXISTS kovid.ReportArguments (
  ...
  CONSTRAINT Argument_Id_UNIQUE UNIQUE  (Argument_Id)
 ,
